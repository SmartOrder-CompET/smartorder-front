    ...
    return(
        <main className="h-screen flex flex-col ">
            ...
            <div className="bg-[#22222280] px-5 rounded-t-4xl flex-1">
                ...
                <div>
                    <h4 className="mt-5 text-lg">Qual o ponto da carne? <span className="text-primary">*</span></h4>
                    ...
                    {meatPoints.map(({ id, label }) => (
                        ...
                        >
                            ...
                            />
                            <span className=" text-gray-300 hover:text-orange-400">{label}</span>
                        </label>
                    ))}
                </div>
                ...
                <div className="mt-5">
                    <div className="flex items-center">
                        <BsChatDotsFill className="text-lg mr-2"/>
